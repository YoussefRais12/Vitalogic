...
<head>
    ...
    <link rel="stylesheet" href="views/assets1/bootstrap/css/bootstrap.css" type="text/css">
    <link rel="stylesheet" href="views/assets1/fonts/font-awesome.css" type="text/css">
    <link rel="stylesheet" href="views/assets1/css/selectize.css" type="text/css">
    <link rel="stylesheet" href="views/assets1/css/style.css">
    <link rel="stylesheet" href="views/assets1/css/user.css">
...
<body>
                        ...
                        <div class="wrapper">
                            <div class="image">
                                <h3>
                                    ...
                                    <a class="title">dog for adoption</a>
                                </h3>
                                <a class="image-wrapper background-image">
                                    <img src="assets1/img/image-01.jpg" alt="">
                                </a>
                            </div>
                            <div class="price">$80</div>
                            <div class="description">
                                <p>blablablablablbalbalbalblablablablablablal</p>
                            </div>
                            
                            <a class="detail text-caps underline">Detail</a>
                        </div>
                    </div>
    ...
    <script src="views/assets1/js/jquery-3.3.1.min.js"></script>
    <script type="text/javascript" src="views/assets1/js/popper.min.js"></script>
    <script type="text/javascript" src="views/assets1/bootstrap/js/bootstrap.min.js"></script>
    
    <script src="views/assets1/js/selectize.min.js"></script>
    <script src="views/assets1/js/masonry.pkgd.min.js"></script>
    <script src="views/assets1/js/icheck.min.js"></script>
    <script src="views/assets1/js/jquery.validate.min.js"></script>
    <script src="views/assets1/js/custom.js"></script>
