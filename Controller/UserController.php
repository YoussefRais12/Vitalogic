...
include $_SERVER['DOCUMENT_ROOT'].'/vitalogic/config.php';
include $_SERVER['DOCUMENT_ROOT'].'/vitalogic/Model/user.php';
...
if($count == 0){
           ...
           header("refresh: 0; url = http://localhost/vitalogic/view/dash/showM.php");
